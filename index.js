...
function deposit() {
    inquirer.prompt([
        ...
        inquirer.prompt([
            {
                name: "amount",
                message: "Quando você deseja despositar ?"
            }
        ]).then((answer) => {
...
function removeAmount(accountName, amount) {
    ...
    // checks
    if (!amount) {
        console.log(chalk.bgRed.black("Ocorreu um erro, tente novamnete !"))
        widthdraw()
    }
    ...
    console.log(chalk.green(`Foi reliazdo um saque de R$${amount} da sua conta !`))
    operation()
}
